...
const team = [
  {
    name: 'Adunni Okafor',
    role: 'Co-Founder & CEO',
    bio: 'Former Uber Nigeria lead with 8+ years in transportation tech. Passionate about solving African mobility challenges.',
    image:
  ...
  },
  {
    name: 'Chike Emeka',
    role: 'Co-Founder & CTO',
    bio: 'Ex-Google software engineer specializing in scalable systems. Built ride-sharing platforms across 3 continents.',
    image:
  ...
  },
  {
    ...
    role: 'Head of Safety',
    bio: 'Former security consultant with expertise in risk management and community safety protocols.',
    image:
  ...
  },
  {
    ...
    bio: 'Community builder with 6+ years experience growing user communities across Africa.',
    image:
        ...
        <FadeIn delay={1.2}>
          <section
            ...
            <p className='text-lg text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed'>
              Whether you&apos;re looking for affordable rides, want to earn extra
              income, or simply believe in building stronger communities,
