...
export function Stats() {
  return (
    <section
      id="stats"
      className="py-24 bg-gradient-to-br from-muted via-background to-muted"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {additionalStats.map((stat, index) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="text-center bg-card rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow duration-300"
                >
                  <div
                  ...
                  <div className="text-xl md:text-2xl font-heading font-bold text-secondary mb-1">
                    {stat.value}
                  </div>
                  <div className="font-body font-medium text-secondary text-sm mb-1">
                    {stat.label}
                  </div>
        ...
        {/* Call to Action */}
        <FadeIn delay={0.8}>
          <div className="text-center mt-16 bg-muted rounded-3xl p-12">
